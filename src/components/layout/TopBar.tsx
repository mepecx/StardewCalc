...
export function TopBar({ view, onViewChange }: TopBarProps) {
  ...
  return (
    <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-3 sticky top-0 z-30 shadow-sm">
      ...
      <div className="flex flex-col sm:flex-row gap-2 flex-1 min-w-0 flex-wrap">
